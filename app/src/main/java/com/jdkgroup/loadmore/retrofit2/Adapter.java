    ...
    * */
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_MOVIE) {
            return new MovieHolder(inflater.inflate(R.layout.adapter_retrofit2, parent, false));
        } else {
            return new LoadHolder(inflater.inflate(R.layout.layout_progrssbar, parent, false));
        }
    }
    ...
    static class MovieHolder extends RecyclerView.ViewHolder {
        ...
        void bindData(Model model) {
            ...
            tvRating.setText("Rating " + model.rating);
        }
    }
